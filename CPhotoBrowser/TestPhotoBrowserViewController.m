...
- (void)viewDidLoad
{
	...
	NSURL *initialUrl = [NSURL URLWithString:@"http://f.hiphotos.bdimg.com/album/s%3D1100%3Bq%3D90/sign=1829f8dbd739b60049ce0bb6d9600e5b/38dbb6fd5266d01604c36510952bd40735fa352b.jpg"];
    ...
    imageView.frame = CGRectMake(10, 80, 300,240);
	imageView.contentMode = UIViewContentModeScaleAspectFill;
	
	UIButton *loadAssetButton = [UIButton buttonWithType:UIButtonTypeCustom];
	[loadAssetButton setTitle:@"Assets" forState:UIControlStateNormal];
